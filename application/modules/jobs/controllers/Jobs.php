...
class Jobs extends MX_Controller
{
 ...
 public function dates_data(){
		...
		foreach($data->rows as $row):
			$data = array("organisationunitid" =>$row[0], "organisationunitname" =>$row[1], "organisationunitcode" =>$row[2], "periodid" =>$row[3], "periodname" =>$row[4], "periodcode" =>$row[5], "Confirmed_Mpox_Cases" =>$row[6], "Mpox_Deaths" =>$row[7], "Suspected_Mpox_Cases" =>$row[8]);
